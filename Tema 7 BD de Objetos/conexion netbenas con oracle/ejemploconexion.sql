...
DROP TABLE DETALLE_ORDENES cascade constraints; 
...
INSERT INTO EMPLEADOS VALUES (1,'JUAN', 'CRUZ', '12-01-67',null, 231);
INSERT INTO EMPLEADOS VALUES (2,'MARIO', 'SANCHEZ', '01-03-79',1,144);
INSERT INTO EMPLEADOS VALUES (3,'VERONICA', 'ARIAS', '12-06-77',1, 234);
INSERT INTO EMPLEADOS VALUES (4,'PABLO', 'CELY', '12-01-77',2, 567);
INSERT INTO EMPLEADOS VALUES (5,'DIEGO', 'ANDRADE', '12-05-70',2, 890);
INSERT INTO EMPLEADOS VALUES (6,'JUAN', 'ANDRADE', '10-11-76',3, 230);
INSERT INTO EMPLEADOS VALUES (7,'MARIA', 'NOBOA', '2-12-79',3, 261);
...
INSERT INTO ORDENES VALUES(1,3,4,'11-06-07', 5);
...
INSERT INTO ORDENES VALUES(7,2,5,'10-06-07', 10);
INSERT INTO ORDENES VALUES(8,3,2,'10-06-07', 10);
INSERT INTO ORDENES VALUES(9,3,2,'11-06-07', 3);
INSERT INTO ORDENES VALUES(10,2,2,'12-06-07', 2);
...
CREATE OR REPLACE FUNCTION cantidadProductos (cat IN NUMBER)
RETURN NUMBER
AS
	num_productos NUMBER;
BEGIN
	SELECT COUNT (*) INTO num_productos FROM productos WHERE categoriaid=cat;
